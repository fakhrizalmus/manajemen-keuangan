        ...
        <div class="pc-content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="page-header-title">
                                        <h2 class="mb-0">Master Pemasukan</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form method="GET" action="{{ route('pemasukans') }}">
            ...
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($pemasukan as $index => $item)
                                            <tr>
                                                <td>{{ ($pemasukan->currentPage() - 1) * $pemasukan->perPage() + $index + 1 }}
                                                </td>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modalEditPemasukan{{ $item->id }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0 shadow">
                                                        ...
                                                        <div class="modal-footer justify-content-center">
                                                            <form action="{{ route('delete-pemasukan', $item->id) }}"
                                            ...
                                            <!-- Modal Edit -->
                                            <div class="modal fade" id="modalEditPemasukan{{ $item->id }}"
                                                tabindex="-1"
                                                aria-labelledby="modalEditPemasukanLabel{{ $item->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <form action="{{ route('edit-pemasukan', $item->id) }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="modalEditPemasukanLabel{{ $item->id }}">
                                                                    Edit Pemasukan</h5>
                ...
                <div class="modal fade" id="modalTambahPemasukan" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form action="{{ route('store-pemasukan') }}" method="POST"
