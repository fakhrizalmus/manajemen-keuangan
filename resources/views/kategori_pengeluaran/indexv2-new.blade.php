        ...
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Kategori Pengeluaran</li>
                            </ul>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="page-header-title">
                                        <h2 class="mb-0">Master Kategori Pengeluaran</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form method="GET" action="{{ route('kategori_pengeluarans') }}">
            ...
            <div class="row">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content border-0 shadow">
                                                        ...
                                                        <div class="modal-footer justify-content-center">
                                                            <form
                                                                action="{{ route('delete-kategori_pengeluaran', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="modalEditKategori{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('edit-kategori_pengeluaran', $item->id) }}"
                ...
                <div class="modal fade" id="modalTambahKategori" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form action="{{ route('store-kategori_pengeluaran') }}" method="POST">
                                @csrf
                                <div class="modal-header">
